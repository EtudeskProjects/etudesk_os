...
const translations = {
  fr: {
    tagline: 'Opportunites  /  Communautes  /  Espaces',
    badge: 'Disponible sur iOS et Android',
    title: 'Ton talent merite\nune plateforme a sa hauteur',
    subtitle:
      'Etudesk connecte les talents aux opportunites, communautes et espaces de travail en Afrique de l\'Ouest. Un assistant intelligent t\'accompagne au quotidien.',
    downloadIOS: 'App Store',
    downloadAndroid: 'Google Play',
    getOnAppStore: 'Telecharger sur',
    getOnPlayStore: 'Disponible sur',
    featuresTitle: 'Tout ce qu\'il te faut, au meme endroit',
    feature1Title: 'Opportunites sur mesure',
    feature1Desc: 'Stages, emplois, projets — trouves par ton assistant personnel qui comprend ton profil, tes competences et tes ambitions.',
    feature2Title: 'Espaces de travail partages',
    feature2Desc: 'Collabore avec d\'autres talents, partage des ressources et travaille dans des espaces dedies a ta productivite.',
    feature3Title: 'Communautes actives',
    feature3Desc: 'Rejoins des communautes de professionnels, echange, participe a des evenements et developpe ton reseau.',
    howTitle: 'Comment ca marche',
    howTalent: 'Talent',
    howOrg: 'Organisation',
    talentStep1Title: 'Cree ton profil',
    talentStep1Desc: 'Inscris-toi en 2 minutes. Renseigne tes competences, ton parcours et ce que tu recherches.',
    talentStep2Title: 'Explore et connecte-toi',
    talentStep2Desc: 'Decouvre des opportunites, rejoins des communautes et accede a des espaces de travail adaptes.',
    talentStep3Title: 'Avance avec ton assistant',
    talentStep3Desc: 'Ton assistant t\'aide a postuler, preparer tes entretiens et suivre ta progression au quotidien.',
    orgStep1Title: 'Creez votre espace',
    orgStep1Desc: 'Inscrivez votre organisation en quelques clics. Ajoutez votre equipe et configurez votre profil.',
    orgStep2Title: 'Publiez et recrutez',
    orgStep2Desc: 'Publiez des opportunites, creez des communautes et trouvez les talents qui correspondent a vos besoins.',
    orgStep3Title: 'Pilotez avec votre assistant',
    orgStep3Desc: 'Votre assistant vous aide a trier les candidatures, gerer vos evenements et animer vos communautes.',
    ctaTitle: 'Pret a commencer ?',
    ctaSubtitle: 'Telecharge l\'application et rejoins la communaute.',
...
const IOS_URL = 'https://apps.apple.com/ci/app/etudesk-os/id6761573837';
const ANDROID_URL = 'https://play.google.com/store/apps/details?id=com.etudesk.mobile';
