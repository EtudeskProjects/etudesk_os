...
const translations = {
  fr: {
    ...
    subtitle:
      'Etudesk connecte les talents aux bonnes opportunités, aux bonnes personnes et aux bons espaces. Avec un copilote IA qui comprend vos ambitions.',
  ...
  en: {
    ...
    subtitle:
      'Etudesk connects talents to the right opportunities, the right people, and the right spaces. With an AI copilot that understands your ambitions.',
    ...
    <main className="coming-soon">
      ...
      <footer className="footer">
        <div className="footer-links">
          ...
          <span className="footer-dot" aria-hidden="true" />
          <a href="/mentions-legales">{t.legal}</a>
        </div>
