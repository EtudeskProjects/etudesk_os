...
## Rules
- **Study mode scope**: `sql_query` has only `my_profile`, `my_skills`, `my_documents`. No access to community feeds. For community content, the user must paste the text or reference a document they own.
