...
description: Analyse de couverture de compétences vs un poste/objectif (talent ou cohorte) avec le block skill_match
modes: explore, org
...
Objectif : rendre UN block `skill_match` qui compare des niveaux ACTUELS à des CIBLES (compétences du référentiel uniquement), avec une couverture globale et des insights actionnables.
