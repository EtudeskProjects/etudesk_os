...
-- ═══════════════════════════════════════════════════════════════════════════════
-- FRESH-INSTALL CONSOLIDATION (correctif install fraiche)
-- Ces objets etaient references par des migrations incrementales (009/015/020)
-- mais n'etaient crees nulle part dans la chaine active (migration billing sortie
-- vers migrations_legacy/, colonne talents.preferred_language jamais ajoutee).
-- Integres au baseline pour qu'une base fraiche se construise sans patch manuel.
-- Idempotent : sans effet sur une base deja migree (001 deja applique).
-- ═══════════════════════════════════════════════════════════════════════════════

-- talents.preferred_language (010 ne l'ajoute qu'a users ; 015 modifie son defaut)
ALTER TABLE talents ADD COLUMN IF NOT EXISTS preferred_language VARCHAR(5) DEFAULT 'en';

-- --- Modele de facturation par credits (Talent + Organization) + paiements Paystack ---
