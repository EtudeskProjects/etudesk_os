-- ═════════════════════════════════════════════════════════════════════
-- ETUDESK OS — ULTRA REALISTIC SEED (CI/UEMOA flavored)
...
INSERT INTO talents (
  ...
  (
    ...
    '/uploads/seed/avatars/aminata-kone.svg',
    'female',
  ...
  (
    ...
    '/uploads/seed/avatars/moussa-diallo.svg',
    'male',
  ...
  (
    ...
    '/uploads/seed/avatars/fatou-traore.svg',
    'female',
  ...
  (
    ...
    '/uploads/seed/avatars/awa-diop.svg',
    'female',
  ...
  (
    ...
    '/uploads/seed/avatars/ibrahim-oue.svg',
    'male',
  ...
  (
    ...
    '/uploads/seed/avatars/kadiatou-coulibaly.svg',
    'female',
  ...
  (
    ...
    '/uploads/seed/avatars/ousmane-gueye.svg',
    'male',
  ...
  (
    ...
    '/uploads/seed/avatars/adjoua-bamba.svg',
    'female',
    'adjoua.bamba@etudesk.demo',
    '+2250709090909',
    'Bouaké', 'Vallée du Bandama', 'CI',
    false, false,
  ...
  (
    ...
    'cheick-sanogo',
    'Cheick', 'Sanogo',
    'Entrepreneur retail. Mise en place de points de vente, gestion stock, mobile money, formation vendeurs. Objectif: scaler sur Abidjan et l''intérieur.',
    '/uploads/seed/avatars/cheick-sanogo.svg',
    'male',
  ...
  (
    ...
    '/uploads/seed/avatars/mariama-faye.svg',
    'female',
  ...
  (
    ...
    '/uploads/seed/avatars/konan-yao.svg',
    'male',
    'konan.yao@etudesk.demo',
    '+2250712121212',
    'San-Pédro', 'Bas-Sassandra', 'CI',
    true, true,
    ARRAY['SALARIED'],
    ARRAY['ADVANCE_CAREER','LEARN_NEW_SKILLS'],
  ...
  (
    ...
    '/uploads/seed/avatars/ndeye-ndiaye.svg',
    'female',
    'ndeye.ndiaye@etudesk.demo',
    '+221750131313',
    'Saint-Louis', 'Saint-Louis', 'SN',
    true, false,
    ARRAY['STUDENT'],
  ...
  (
    ...
    '/uploads/seed/avatars/sekou-keita.svg',
    'male',
  ...
  (
    ...
    '/uploads/seed/avatars/aicha-sow.svg',
    'female',
    'aicha.sow@etudesk.demo',
    '+221770151515',
    'Ziguinchor', 'Ziguinchor', 'SN',
    false, true,
    ARRAY['ENTREPRENEUR'],
  ...
  (
    ...
    '/uploads/seed/avatars/jeanne-ouattara.svg',
    'female',
  ...
  (
    ...
    '/uploads/seed/avatars/tidiane-cisse.svg',
    'male',
  ...
  (
    ...
    '/uploads/seed/avatars/estelle-zongo.svg',
    'female',
  ...
  (
    ...
    '/uploads/seed/avatars/boubacar-diarra.svg',
    'male',
  ...
  (
    ...
    '/uploads/seed/avatars/coumba-fall.svg',
    'female',
...
-- ---------------------------------------------------------------------
-- 2) Talent Skills (HARD_SKILL / SOFT_SKILL / KNOWLEDGE)
-- ---------------------------------------------------------------------

-- A small, high-signal skill set per talent (for search/matching realism).
INSERT INTO talent_skills (id, talent_id, canonical_name, type, proficiency_level, origin, context)
VALUES
  -- Lamine
  ('92000000-0000-4000-8000-000000000001','90000000-0000-4000-8000-000000000001','Product Strategy','KNOWLEDGE','EXPERT','declared','Roadmaps, priorisation, exécution.'),
  ('92000000-0000-4000-8000-000000000002','90000000-0000-4000-8000-000000000001','Partnerships','KNOWLEDGE','EXPERT','declared','Partenariats écoles/entreprises.'),
  ('92000000-0000-4000-8000-000000000003','90000000-0000-4000-8000-000000000001','Leadership','SOFT_SKILL','EXPERT','declared','Gestion équipe, décisions.'),
  ('92000000-0000-4000-8000-000000000004','90000000-0000-4000-8000-000000000001','EdTech','KNOWLEDGE','EXPERT','declared','Apprentissage, contenu, outcomes.'),

  -- Aminata
  ('92000000-0000-4000-8000-000000000005','90000000-0000-4000-8000-000000000002','React','HARD_SKILL','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000006','90000000-0000-4000-8000-000000000002','Node.js','HARD_SKILL','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000007','90000000-0000-4000-8000-000000000002','PostgreSQL','HARD_SKILL','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000008','90000000-0000-4000-8000-000000000002','Communication','SOFT_SKILL','EXPERT','declared','Relation produit/tech.'),

  -- Moussa
  ('92000000-0000-4000-8000-000000000009','90000000-0000-4000-8000-000000000003','Project Planning','KNOWLEDGE','INTERMEDIATE','declared','Planning, suivi, reporting.'),
  ('92000000-0000-4000-8000-000000000010','90000000-0000-4000-8000-000000000003','Excel','HARD_SKILL','EXPERT','declared','Tableaux, budgets, KPI.'),
  ('92000000-0000-4000-8000-000000000011','90000000-0000-4000-8000-000000000003','Teamwork','SOFT_SKILL','EXPERT','declared',NULL),

  -- Fatou
  ('92000000-0000-4000-8000-000000000012','90000000-0000-4000-8000-000000000004','Content Marketing','KNOWLEDGE','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000013','90000000-0000-4000-8000-000000000004','Growth','KNOWLEDGE','INTERMEDIATE','declared','Acquisition, activation.'),
  ('92000000-0000-4000-8000-000000000014','90000000-0000-4000-8000-000000000004','Negotiation','SOFT_SKILL','INTERMEDIATE','declared',NULL),

  -- Awa
  ('92000000-0000-4000-8000-000000000015','90000000-0000-4000-8000-000000000005','SQL','HARD_SKILL','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000016','90000000-0000-4000-8000-000000000005','Power BI','HARD_SKILL','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000017','90000000-0000-4000-8000-000000000005','Analytics','KNOWLEDGE','INTERMEDIATE','declared',NULL),

  -- Ibrahim
  ('92000000-0000-4000-8000-000000000018','90000000-0000-4000-8000-000000000006','TypeScript','HARD_SKILL','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000019','90000000-0000-4000-8000-000000000006','API Design','KNOWLEDGE','INTERMEDIATE','declared','REST, versioning.'),
  ('92000000-0000-4000-8000-000000000020','90000000-0000-4000-8000-000000000006','Security','KNOWLEDGE','INTERMEDIATE','declared','Auth, RBAC.'),

  -- Kadiatou
  ('92000000-0000-4000-8000-000000000021','90000000-0000-4000-8000-000000000007','Recruiting','KNOWLEDGE','EXPERT','declared','Scorecards, process.'),
  ('92000000-0000-4000-8000-000000000022','90000000-0000-4000-8000-000000000007','People Ops','KNOWLEDGE','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000023','90000000-0000-4000-8000-000000000007','Communication','SOFT_SKILL','EXPERT','declared',NULL),

  -- Ousmane
  ('92000000-0000-4000-8000-000000000024','90000000-0000-4000-8000-000000000008','Docker','HARD_SKILL','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000025','90000000-0000-4000-8000-000000000008','CI/CD','HARD_SKILL','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000026','90000000-0000-4000-8000-000000000008','Linux','HARD_SKILL','EXPERT','declared',NULL),

  -- Adjoua
  ('92000000-0000-4000-8000-000000000027','90000000-0000-4000-8000-000000000009','Career Coaching','KNOWLEDGE','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000028','90000000-0000-4000-8000-000000000009','Public Speaking','SOFT_SKILL','INTERMEDIATE','declared',NULL),

  -- Cheick
  ('92000000-0000-4000-8000-000000000029','90000000-0000-4000-8000-000000000010','Sales Ops','KNOWLEDGE','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000030','90000000-0000-4000-8000-000000000010','Inventory Management','KNOWLEDGE','INTERMEDIATE','declared',NULL),

  -- Mariama
  ('92000000-0000-4000-8000-000000000031','90000000-0000-4000-8000-000000000011','Community Management','KNOWLEDGE','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000032','90000000-0000-4000-8000-000000000011','Moderation','KNOWLEDGE','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000033','90000000-0000-4000-8000-000000000011','Writing','SOFT_SKILL','EXPERT','declared',NULL),

  -- Konan
  ('92000000-0000-4000-8000-000000000034','90000000-0000-4000-8000-000000000012','Solar Projects','KNOWLEDGE','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000035','90000000-0000-4000-8000-000000000012','Operations','KNOWLEDGE','INTERMEDIATE','declared',NULL),

  -- Ndeye
  ('92000000-0000-4000-8000-000000000036','90000000-0000-4000-8000-000000000013','Research Methods','KNOWLEDGE','BEGINNER','declared',NULL),
  ('92000000-0000-4000-8000-000000000037','90000000-0000-4000-8000-000000000013','Statistics','HARD_SKILL','BEGINNER','declared',NULL),

  -- Sekou
  ('92000000-0000-4000-8000-000000000038','90000000-0000-4000-8000-000000000014','React Native','HARD_SKILL','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000039','90000000-0000-4000-8000-000000000014','Mobile Analytics','KNOWLEDGE','INTERMEDIATE','declared',NULL),

  -- Aicha
  ('92000000-0000-4000-8000-000000000040','90000000-0000-4000-8000-000000000015','Go-to-market','KNOWLEDGE','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000041','90000000-0000-4000-8000-000000000015','Supply Chain','KNOWLEDGE','BEGINNER','declared',NULL),

  -- Jeanne
  ('92000000-0000-4000-8000-000000000042','90000000-0000-4000-8000-000000000016','Excel','HARD_SKILL','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000043','90000000-0000-4000-8000-000000000016','Teaching','SOFT_SKILL','EXPERT','declared',NULL),

  -- Tidiane
  ('92000000-0000-4000-8000-000000000044','90000000-0000-4000-8000-000000000017','Product Management','KNOWLEDGE','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000045','90000000-0000-4000-8000-000000000017','Metrics','KNOWLEDGE','INTERMEDIATE','declared',NULL),

  -- Estelle
  ('92000000-0000-4000-8000-000000000046','90000000-0000-4000-8000-000000000018','Figma','HARD_SKILL','EXPERT','declared',NULL),
  ('92000000-0000-4000-8000-000000000047','90000000-0000-4000-8000-000000000018','UX Research','KNOWLEDGE','INTERMEDIATE','declared',NULL),

  -- Boubacar
  ('92000000-0000-4000-8000-000000000048','90000000-0000-4000-8000-000000000019','Logistics','KNOWLEDGE','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000049','90000000-0000-4000-8000-000000000019','Process Improvement','KNOWLEDGE','BEGINNER','declared',NULL),

  -- Coumba
  ('92000000-0000-4000-8000-000000000050','90000000-0000-4000-8000-000000000020','Program Management','KNOWLEDGE','INTERMEDIATE','declared',NULL),
  ('92000000-0000-4000-8000-000000000051','90000000-0000-4000-8000-000000000020','Monitoring & Evaluation','KNOWLEDGE','BEGINNER','declared',NULL);
...
INSERT INTO communities (
  ...
  (
    ...
    'Abidjan','Lagunes','CI',
    '/uploads/seed/covers/community-tech-data.svg',
    ARRAY['/uploads/seed/covers/community-tech-data.svg'],
    'ACTIVE',
    '90000000-0000-4000-8000-000000000001',
    '10000000-0000-4000-8000-000000000001',
    false, NULL, 'XOF', 0
  ...
  (
    ...
    'Abidjan','Lagunes','CI',
    '/uploads/seed/covers/community-entrepreneurs.svg',
    ARRAY['/uploads/seed/covers/community-entrepreneurs.svg'],
    'ACTIVE',
    '90000000-0000-4000-8000-000000000010',
    '10000000-0000-4000-8000-000000000001',
    false, NULL, 'XOF', 0
...
INSERT INTO opportunities (
  ...
  (
    ...
    '/uploads/seed/covers/opp-fullstack.svg',
    ARRAY['/uploads/seed/covers/opp-fullstack.svg'],
    '[]'::jsonb,
    600000, 1200000, 'XOF', 'MONTHLY',
    'HYBRID',
    '[{"city":"Abidjan","region":"Lagunes","country":"CI","is_primary":true}]'::jsonb,
    'PUBLIC',
    NOW() - INTERVAL '7 days',
  ...
  (
    ...
    '/uploads/seed/covers/opp-data.svg',
    ARRAY['/uploads/seed/covers/opp-data.svg'],
    '[]'::jsonb,
    450000, 900000, 'XOF', 'MONTHLY',
    'REMOTE',
    '[{"city":"Abidjan","country":"CI","is_primary":true},{"city":"Dakar","country":"SN"}]'::jsonb,
    'PUBLIC',
    NOW() - INTERVAL '4 days',
  ...
  (
    ...
    false,
    '[]'::jsonb,
    '/uploads/seed/covers/opp-community.svg',
    ARRAY['/uploads/seed/covers/opp-community.svg'],
    '[]'::jsonb,
    0, 250000, 'XOF', 'PROJECT',
    'REMOTE',
    '[{"country":"CI","is_primary":true}]'::jsonb,
    'PUBLIC',
  ...
  (
    ...
    'Support sur la gestion des espaces: planning, demandes, suivi qualité, retours clients. Missions terrain Abidjan.',
    '- Organisation\n- Rigueur\n- Sens du service\n',
    'Excel/Sheets.',
    '10000000-0000-4000-8000-000000000001',
    ARRAY['SERVICES','TECH'],
    false,
    '[]'::jsonb,
    '/uploads/seed/covers/space-formation.svg',
    ARRAY['/uploads/seed/covers/space-formation.svg'],
    '[]'::jsonb,
  ...
  (
    ...
    '/uploads/seed/covers/opp-ux.svg',
    ARRAY['/uploads/seed/covers/opp-ux.svg'],
    '[]'::jsonb,
    400000, 900000, 'XOF', 'MONTHLY',
    'HYBRID',
    '[{"city":"Abidjan","country":"CI","is_primary":true}]'::jsonb,
    'PUBLIC',
    NOW() - INTERVAL '5 days',
  ...
  (
    ...
    false,
    '[]'::jsonb,
    '/uploads/seed/covers/opp-devops.svg',
    ARRAY['/uploads/seed/covers/opp-devops.svg'],
    '[]'::jsonb,
  ...
  (
    ...
    false,
    '[]'::jsonb,
    '/uploads/seed/covers/opp-trainer.svg',
    ARRAY['/uploads/seed/covers/opp-trainer.svg'],
    '[]'::jsonb,
    0, 0, 'XOF', 'PROJECT',
    'ON_SITE',
    '[{"city":"Abidjan","region":"Lagunes","country":"CI","is_primary":true}]'::jsonb,
  ...
  (
    ...
    false,
    '[]'::jsonb,
    '/uploads/seed/covers/opp-program.svg',
    ARRAY['/uploads/seed/covers/opp-program.svg'],
    '[]'::jsonb,
...
INSERT INTO spaces (
  ...
  (
    ...
    'Accès plain-pied.',
    '/uploads/seed/covers/space-studio.svg',
    ARRAY['/uploads/seed/covers/space-studio.svg'],
